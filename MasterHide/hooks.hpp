...
using NtAllocateVirtualMemory_ = NTSTATUS(NTAPI *)(HANDLE ProcessHandle, PVOID *BaseAddress, ULONG_PTR ZeroBits,
...
using NtFreeVirtualMemory_ = NTSTATUS(NTAPI *)(HANDLE ProcessHandle, PVOID *BaseAddress, PSIZE_T RegionSize,
                                               ULONG FreeType);
...
using NtWriteVirtualMemory_ = NTSTATUS(NTAPI *)(HANDLE ProcessHandle, PVOID BaseAddress, PVOID Buffer,
...
using NtDeviceIoControlFile_ = NTSTATUS(NTAPI *)(HANDLE FileHandle, HANDLE Event, PIO_APC_ROUTINE ApcRoutine,
...
using NtUserBuildHwndList_ = NTSTATUS(NTAPI *)(HDESK hdesk, HWND hwndNext, ULONG fEnumChildren, DWORD idThread,
