...
namespace service
{
inline bool Start(SC_HANDLE serviceHandle)
{
...
inline bool Delete(SC_HANDLE serviceHandle)
{
...
inline bool Stop(SC_HANDLE serviceHandle, LPSERVICE_STATUS serviceStatus)
{
    return static_cast<bool>(ControlService(serviceHandle, SERVICE_CONTROL_STOP, serviceStatus));
}

inline SC_HANDLE CreateOrOpen(const std::string &name, const std::string &displayName, const std::string &path)
{
